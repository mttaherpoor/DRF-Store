...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for _ in range(NUM_PRODUCTS):
            ...
            naive_datetime = datetime(random.randrange(2019, 2023), random.randint(1, 12), random.randint(1, 12))
            new_product.datetime_created = timezone.make_aware(naive_datetime)
        ...
        for order in all_orders:
            ...
            naive_datetime = datetime(random.randrange(2019, 2023), random.randint(1, 12), random.randint(1, 12))
            order.datetime_created = timezone.make_aware(naive_datetime)
        ...
        for product in all_products:
            for _ in range(random.randint(1, 5)):
                ...
                naive_datetime = datetime(random.randrange(2019, 2023), random.randint(1, 12), random.randint(1, 12))
                comment.datetime_created = timezone.make_aware(naive_datetime)
